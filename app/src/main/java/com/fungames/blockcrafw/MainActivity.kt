...
import com.fungames.blockcrafw.Apppppp.Companion.AF_DEV_KEY
import com.fungames.blockcrafw.Apppppp.Companion.C1
import com.fungames.blockcrafw.Apppppp.Companion.CH
import com.fungames.blockcrafw.Apppppp.Companion.D1
import com.fungames.blockcrafw.Apppppp.Companion.linkAppsCheckPart1
import com.fungames.blockcrafw.Apppppp.Companion.linkAppsCheckPart2
import com.fungames.blockcrafw.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun skipMe() {
        Intent(this, MAg::class.java)
            .also { startActivity(it) }
        finish()
    }
    private fun testWV() {
        Intent(this, Wbe::class.java)
            .also { startActivity(it) }
        finish()
    }
