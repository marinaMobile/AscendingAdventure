...
import com.fungames.blockcrafw.Apppppp.Companion.MAIN_ID
import com.fungames.blockcrafw.databinding.ActivityWbeBinding
...
class Wbe : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWbeBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWbeBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.fungames.blockcrafw"
        ...
        val first = "http://"
        val second = "ascendingadventure.xyz/go.php?to=2&"
